...
{
	XMFLOAT4 mEyePosition = XMFLOAT4(0.0f, 0.0f, -3.0f, 1.0f);
	...
	mProjectionMatrix = XMMatrixOrthographicLH(1280, 720, 0, 1);
...
void Sprite::CreateBuffers(ID3D11Device* dev)
{
	...
	vertices[0].position = XMFLOAT3(-1, 1, 0.0f);  // Top left.
	vertices[0].texture = XMFLOAT2(0.0f, 0.0f);

	vertices[1].position = XMFLOAT3(1, -1, 0.0f);  // Bottom right.
	vertices[1].texture = XMFLOAT2(1.0f, 1.0f);

	vertices[2].position = XMFLOAT3(-1, -1, 0.0f);  // Bottom left.
	vertices[2].texture = XMFLOAT2(0.0f, 1.0f);

	// Second triangle.
	vertices[3].position = XMFLOAT3(-1, 1, 0.0f);  // Top left.
	vertices[3].texture = XMFLOAT2(0.0f, 0.0f);

	vertices[4].position = XMFLOAT3(1, 1, 0.0f);  // Top right.
	vertices[4].texture = XMFLOAT2(1.0f, 0.0f);

	vertices[5].position = XMFLOAT3(1, -1, 0.0f);  // Bottom right.
